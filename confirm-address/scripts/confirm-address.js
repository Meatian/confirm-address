var ConfirmAddress = {
	...
	checkAddress: function () {
		...
		console.log("[TO] " + this.strList(toList) + "\n");
		console.log("[CC] " + this.strList(ccList) + "\n");
		console.log("[BCC] " + this.strList(bccList) + "\n");
		...
		console.log("[INTERNAL] " + this.strList(internalList) + "\n");
		console.log("[EXTERNAL] " + this.strList(externalList) + "\n");
   ...
   * addressArrayに含まれるアドレスを判定し、組織外、組織内に振り分けます
	...
	judge: function (addressArray, domainList, yourDomainAddress, otherDomainAddress) {
		console.log("[JUDGE] " + this.strList(addressArray) + "\n");
