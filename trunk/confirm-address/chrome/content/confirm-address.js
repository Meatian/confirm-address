function CheckAddresses()
{
	...
	judge(toList, domainList, hskArray, otherArray);
	judge(ccList, domainList, hskArray, otherArray);
	judge(bccList, domainList, hskArray, otherArray);
	
	dump("[INTERNAL] "+ hskArray + "\n");
	dump("[EXTERNAL] "+ otherArray + "\n");
	
	window.confirmOK = false;
	window.openDialog("chrome://confirm-address/content/confirm-address-dialog.xul",
		"ConfirmAddressDialog", "resizable,chrome,modal,titlebar,centerscreen", window, hskArray, otherArray);
